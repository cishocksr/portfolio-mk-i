    ...
    <Layout title='Home'>
      ...
      >
        ...
        <h6 className='my-3 text-base font-medium text-libre'>
          Take a stroll through my growth as an engineer. You can find some of
          my previous work, learn a little about who I am, and if you would
          like, we can work on something that will help us grow as individuals,
